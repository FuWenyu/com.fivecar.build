...
@Service(value = "updateCustomerPwdService")
public class UpdateCustomerPwdService extends BaseService implements
		IBusinessService {
	...
	public TransData execute(TransData transData) throws BusinessException {
		...
		if ("ECIF1004".equals(transData.getTradeCode())) {
			return doUpdateCustomerPwd(transData);
		}
		return transData;
	}

	private TransData doUpdateCustomerPwd(TransData transData) {
