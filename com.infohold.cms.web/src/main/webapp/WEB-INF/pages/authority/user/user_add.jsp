			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" id="sub_form" action="<%=path%>/mvc/user_addSave.do"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="loginid" name="loginid" placeholder="请输入登录ID"
								...
								value="${userEntity.loginid}" /> <span style="color: red">${errorMessage }</span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="name" placeholder="请输入用户名称"
								class="col-xs-10 col-sm-5" name="name" value="${userEntity.name}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select name="organizationid" id="organizationId" class="col-xs-10 col-sm-5" data-emptyoption="true"  data-select-list="${guaranteeList }">
							</select>
						</div>
					</div>
					...
					<div class="clearfix form-actions">
						<div class="col-md-offset-3 col-md-9">
							...
							&nbsp; &nbsp; &nbsp;
							<button class="btn" type="button" onclick="javascript:window.location = '<%=path%>/mvc/user_getList.do?type=cms';">
