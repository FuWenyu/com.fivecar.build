			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" id="sub_form" action="<%=path%>/mvc/user_editSave.do"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select name="organizationid" id="organizationId" class="col-xs-10 col-sm-5" data-emptyoption="false" data-select-value="${userEntity.organizationid}" data-select-list="${guaranteeList }">
							</select>
						</div>
					</div>
