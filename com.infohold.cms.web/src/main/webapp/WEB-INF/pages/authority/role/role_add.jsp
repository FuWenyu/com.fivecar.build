...
<html lang="en">
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" id="sub_form" action="" method="post">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="role_code" placeholder="请输入角色编号" class="col-xs-10 col-sm-5" name="role_code" value="${rolecode}"  readonly="readonly"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="role_name" placeholder="请输入角色名称" class="col-xs-10 col-sm-5" name="role_name" />
						</div>
					</div>
	...
	<script type="text/javascript">
		...
		function subForm() {
			...
			$.ajax({
				type : "POST",
				url : "<%=path%>/mvc/role_addSave.do",
				data : $("#sub_form").serialize(),
				async : false,
				dataType:'json',
				success : function(data) {
					if(data.msg == "success"){
						f_alert("<%=path%>","success","role_getList.do");
					}else{
