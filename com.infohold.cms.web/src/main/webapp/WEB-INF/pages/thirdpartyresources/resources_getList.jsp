...
<html lang="en">
	...
	<body id="iframe_body" onload="setHash('${pageContext.request.contextPath}')">
		...
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<!-- 查询条件begin -->
				<form class="col-xs-12" id="queryForm" name="qry_form" action="tpresources.do?type=cms" method="post">
	...
	<script type="text/javascript">
		...
		function toQry()
		{
			...
			param += "&qry_type=qry";
			$.post("tpresources.do", param, function(result) {			
		...
		function addResourcesEntity(){
			window.location="<%=path%>/tpresources_add.do";
		};
		//跳转至图片编辑页面
		function editEntity(id){
			window.location="<%=path%>/tpresources_edit.do?id="+id+"";
		};
		...
		function deleteEntity(id){
			...
			var param={};
			param["id"]=id;
			$.post("<%=path%>/mvc/tpresources_delete.do",param,function(result){
				movePage(1);
			});
		};
	</script>
