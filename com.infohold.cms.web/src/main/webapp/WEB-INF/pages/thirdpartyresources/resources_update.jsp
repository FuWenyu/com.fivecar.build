...
<jsp:include page="../common/commonList.jsp"></jsp:include><!-- 引入公供js -->
		...
		<div class="row">
			...
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="sub_form" action="<%=path%>/mvc/pictureAddSave.do"
					...
					<input id="purpose1" type="hidden" class="" name="purpose1" value="${resource.purpose}-${resource.purposeName}" />
					<input id="thirdparty_type1" type="hidden" class="" name="thirdparty_type1" value="${resource.thirdparty_type}" />
					<div class="form-group">
	...
	jQuery(function($) {
		...
		var thirdparty_type1 = document.getElementById('thirdparty_type1').value;
		checkOption('thirdparty_type',thirdparty_type1);
	});
		function subForm() {
			...
			$.ajax({
				type : "POST",
				url : "<%=path%>/mvc/tpresources_editSave.do",
