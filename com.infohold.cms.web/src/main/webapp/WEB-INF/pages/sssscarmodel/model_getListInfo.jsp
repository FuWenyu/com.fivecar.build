							...
							<c:forEach items="${vehicleList}" var="vehicleList">
								<tr>
									<td>
										...
										<%-- <img alt="as" src="<%=path%>/upload/goodsimg/${vehicleList.id }/${vehicleList.file_name}"> --%>
										<%-- <a href="javascript:void(0)" onclick="viewFile('${vehicleList.id }','${vehicleList.file_name}')"> ${vehicleList.picture_name}</a> --%>
									</td>
