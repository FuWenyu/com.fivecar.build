			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input name="re_id" id="re_id" placeholder="点击选择" type="text"
								class="col-xs-10 col-sm-8" onclick="selectContract();" value="${map.duebill_id }" readonly>
						</div>
					...
					<div class="form-group">
						...
						<label class="col-sm-2 control-label no-padding-right" for="amount">
							还款金额 </label>
						<div class="col-sm-5">
							<input name="repay_amount" id="repay_amount" class="col-xs-10 col-sm-5"  value="${map.repay_amount }" type="text" readonly>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right"
