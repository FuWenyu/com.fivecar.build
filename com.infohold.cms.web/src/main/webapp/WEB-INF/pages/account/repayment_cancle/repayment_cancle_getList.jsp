...
<body id="iframe_body"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-sm btn-primary" onclick="CallBackSubmit(this);">选择</button>
	...
	<script type="text/javascript">
		...
		function addEntity(){
			window.location="<%=path%>/mvc/repmentAcc_cancle_add.do";
		};
		function editEntity(acc_back_id){
			window.location="<%=path%>/mvc/repmentAcc_cancle_edit.do?acc_back_id="+acc_back_id;
		};
		...
		function CallBackSubmit(obj){
			...
			$.ajax({
    			type : "POST",
    			url : "<%=path%>/mvc/repmentAcc_cancle_approve.do",
    			data : param,
    			async : false,
