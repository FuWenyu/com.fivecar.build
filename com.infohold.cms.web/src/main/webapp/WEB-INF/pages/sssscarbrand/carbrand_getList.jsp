...
<html lang="en">
	...
	<body id="iframe_body" onload="setHash('${pageContext.request.contextPath}')">
		...
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<!-- 查询条件begin -->
				<form class="col-xs-12" id="queryForm" name="qry_form" action="brand.do?type=cms" method="post">
	...
	<script type="text/javascript">
		...
		function toQry()
		{
			...
			param += "&qry_type=qry";
			$.post("brand.do", param, function(result) {			
		...
		//跳转至图片新增页面
		function addEntity(){
			window.location="<%=path%>/mvc/brand_add.do";
		};
		//跳转至图片编辑页面
		...
		function deleteEntity(brandid){
			...
			var param={};
			param["id"]=brandid;
			$.post("<%=path%>/mvc/brand_delete.do",param,function(result){
				movePage(1);
			});
		};
	</script>
