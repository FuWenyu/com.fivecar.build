							...
							<c:forEach items="${brandList}" var="brandList">
								<tr>
									<td>
										...
										<%-- <img alt="as" src="<%=path%>/upload/goodsimg/${brandList.id }/${brandList.file_name}"> --%>
										<%-- <a href="javascript:void(0)" onclick="viewFile('${brandList.id }','${brandList.file_name}')"> ${brandList.picture_name}</a> --%>
									</td>
