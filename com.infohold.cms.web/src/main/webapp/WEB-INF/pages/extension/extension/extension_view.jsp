					...
					<h1 class="breadcrumb">	
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
										<input type="text" id="zqdqrq" disabled="disabled"
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<select id="sfzxxll" class="col-xs-10 col-sm-5"  name="sfzxxll"
								 		data-select-list="${ynList }" data-select-value="${bizExtensionEntity.sfzxxll}" disabled="disabled"></select>
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
										<textarea rows="5" cols="10"  class="col-xs-10 col-sm-5" id="zzyy" name="zzyy" disabled="disabled">"${bizExtensionEntity.sqyy}"</textarea>
                                        </div>
										...
										<div class="col-sm-4">
											<textarea rows="5" cols="10"  class="col-xs-10 col-sm-5" id="remark" name="remark" disabled="disabled">"${bizExtensionEntity.remark}"</textarea>
