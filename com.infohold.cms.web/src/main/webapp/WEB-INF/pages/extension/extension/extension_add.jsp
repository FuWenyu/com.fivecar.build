...
<html lang="en">
					...
					<h1 class="breadcrumb">	
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="outstandingPrincipalBalance" placeholder="" onblur="clean()" readonly="readonly"
												class="col-xs-10 col-sm-5" name="outstandingPrincipalBalance"  />
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<input type="text" id="sqsj"
										        class="col-xs-10 col-sm-5" name="sqsj"  value="${sqrq}"  readonly="readonly"/>
										</div>
										...
										<input type="text" id="zqdqrq"
										        class="col-xs-10 col-sm-5 date-picker" name="zqdqrq"   data-date-format="yyyy-mm-dd"/>
                                        </div>
										<div class="col-md-1"></div>
									</div>									
								</div>
								<div class="row">
									...
									<div class="form-group">										
										...
										<select id="sfzxxll" class="col-xs-10 col-sm-5"  name="sfzxxll"
								 		data-select-list="${ynList }" data-select-value="y" ></select>
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<input type="text" id="zqcs" 
											class="col-xs-10 col-sm-5" name="zqcs" onblur="clean()" readonly="readonly"/>
                                        </div>
										...
										<div class="col-sm-4">
											<input type="text" id="zdzqrq" 
												...
												value="${afterLoanRepaymentEntrty.zdzqrq }" onblur="clean()" readonly="readonly"/>
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
										<textarea rows="5" cols="10"  class="col-xs-10 col-sm-5" id="zzyy" name="zzyy"></textarea>
                                        </div>
										...
										<div class="col-sm-4">
											<textarea rows="5" cols="10"  class="col-xs-10 col-sm-5" id="remark" name="remark"></textarea>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="cust_id" placeholder="   "
												...
												value="${afterLoanRepaymentEntrty.cust_id }" readonly="readonly"/>
										</div>
										...
										<div class="col-sm-4">
											<input type="text" id=cust_name placeholder=""
												...
												value="${afterLoanRepaymentEntrty.cust_name }" readonly="readonly"/>
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="constart" placeholder="   "
												...
												value="${afterLoanRepaymentEntrty.constart }" readonly="readonly"/>
										</div>
										...
										<div class="col-sm-4">
											<input type="text" id="conend" placeholder=""
												...
												value="${afterLoanRepaymentEntrty.conend }" readonly="readonly"/>
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="status" placeholder=""
												...
												value="${afterLoanRepaymentEntrty.status }" readonly="readonly"/>
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="billstart" placeholder="  "
												...
												value="${afterLoanRepaymentEntrty.billstart }" readonly="readonly"/>
										</div>
										...
										<div class="col-sm-4">
											<input type="text" id="billend" placeholder=""
												...
												value="${afterLoanRepaymentEntrty.billend }"readonly="readonly"/>
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">     
											<input type="text" id="unpaidPrincipalArrears" placeholder="  "
												class="col-xs-10 col-sm-5" name="unpaidPrincipalArrears"
												readonly="readonly" />
										</div>
										...
										<div class="col-sm-4">
											<input type="text" id="unpaidInterestArrears" placeholder=""
												class="col-xs-10 col-sm-5" name="unpaidInterestArrears" readonly="readonly"/>
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="penaltyArrears" placeholder="   "
												class="col-xs-10 col-sm-5" name="penaltyArrears"  readonly="readonly"/>
										</div>
										...
										<div class="col-sm-4">
											<input type="text" id="compoundingInterestArrears" placeholder=""
												class="col-xs-10 col-sm-5" name="compoundingInterestArrears" readonly="readonly"/>
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="otherArrears" placeholder="   "
												class="col-xs-10 col-sm-5" name="otherArrears" readonly="readonly"/>
										</div>
										<div class="col-md-0"></div>
										<div class="col-md-1"></div>
									</div>									
	...
	jQuery(function($) {
		...
		function subForm() {
			...
			if (document.getElementById("outstandingPrincipalBalance").value==""||document.getElementById("outstandingPrincipalBalance").value==null) {
				f_alert("<%=path%>","展期金额不能为空！","");
				return;
			}
			if (document.getElementById("unpaidPrincipalArrears").value>0) {
				f_alert("<%=path%>","存在未还本金欠款，不可以展期！","");
				return;
			}
			if (document.getElementById("unpaidInterestArrears").value>0) {
				f_alert("<%=path%>","存在未还利息欠款，不可以展期！","");
				return;
			}
			if (document.getElementById("compoundingInterestArrears").value>0) {
				f_alert("<%=path%>","存在未还复利欠款，不可以展期！","");
				return;
			}
			if (document.getElementById("otherArrears").value>0) {
				f_alert("<%=path%>","存在其他欠款，不可以展期！","");
				return;
			}
			...
			$.ajax({
				type : "POST",
				url : "<%=path%>/mvc/extension_addSave.do",
