...
<html lang="en">
					...
					<h1 class="breadcrumb">	
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
										<textarea rows="5" cols="10"  class="col-xs-10 col-sm-5" id="sqyy" name="sqyy" >${bizExtensioncxEntity.sqyy }</textarea>
                                        </div>
										<div class="col-md-0"></div>
										<label class="col-sm-1 control-label no-padding-right"
											for="form-field-2">撤销备注</label>
										<div class="col-sm-4">
											<textarea rows="5" cols="10"  class="col-xs-10 col-sm-5" id="remark" name="remark">${bizExtensioncxEntity.remark }</textarea>	
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
	...
	jQuery(function($) {
		...
		function subForm() {
			$.ajax({
				type : "POST",
				url : "<%=path%>/mvc/extensioncx_editSave.do",
