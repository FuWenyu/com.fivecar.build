...
<html lang="en">
					...
					<h1 class="breadcrumb">	
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
										<input type="text" id="zqxh"
										        class="col-xs-10 col-sm-5" name="zqxh" placeholder="请选展期申请序号" onclick="selectExtension(1)"/>
										...
										<div class="col-sm-4">
											<input type="text" id="sqsj" placeholder="" onblur="clean()" readonly="readonly"
												class="col-xs-10 col-sm-5" name="sqsj"  value="${sqrq}"/>
								...
								<div class="row">
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
										<textarea rows="5" cols="10"  class="col-xs-10 col-sm-5" id="sqyy" name="sqyy"></textarea>
                                        </div>
										<div class="col-md-0"></div>
										<label class="col-sm-1 control-label no-padding-right"
							...
							<h1 class="breadcrumb">	
								<small>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">     
											<input type="text" id="duebill_acct" placeholder="  "
												class="col-xs-10 col-sm-5" name=duebill_acct readonly="readonly" />
										</div>
										<div class="col-md-0"></div>
										<label class="col-sm-1 control-label no-padding-right"
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="start_date" placeholder="   "
										...
										<div class="col-sm-4">
											<input type="text" id="end_date" placeholder=""
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="zqsqsj" 
												class="col-xs-10 col-sm-5" name="zqsqsj" readonly="readonly"/>
										</div>
										<div class="col-md-0"></div>
										<label class="col-sm-1 control-label no-padding-right"
										...
										<div class="col-sm-4">
											<input type="text" id="zqje" 
												class="col-xs-10 col-sm-5" name="zqje"  readonly="readonly"/>
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="zqqsrq" 
												class="col-xs-10 col-sm-5" name="zqqsrq" readonly="readonly"/>
										</div>
										<div class="col-md-0"></div>
										<label class="col-sm-1 control-label no-padding-right"
										...
										<div class="col-sm-4">
											<input type="text" id="zqdqrq" placeholder=""
												class="col-xs-10 col-sm-5" name="zqdqrq"  readonly="readonly"/>
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
									...
									<div class="form-group">										
										...
										<div class="col-sm-4">
											<input type="text" id="jbkhjlmc" 
												class="col-xs-10 col-sm-5" name="jbkhjlmc" value="${jbkhjlmc}" readonly="readonly"/>
											<input type="hidden"  name="sqrbh" id="sqrbh" value="${jbkhjlbh}">
										</div>
										<div class="col-md-0"></div>
										<label class="col-sm-1 control-label no-padding-right"
										...
										<div class="col-sm-4">
											<input type="text" id="jbjgmc" 
												class="col-xs-10 col-sm-5" name="jbjgmc" value="${jbjgmc}"readonly="readonly"/>
											<input type="hidden"  name="sqjgbh" id="sqjgbh" value="${jbjgbh}">
										</div>
										<div class="col-md-1"></div>
									</div>									
								</div>
	...
	jQuery(function($) {
		...
		function subForm() {
			$.ajax({
				type : "POST",
				url : "<%=path%>/mvc/extensioncx_addSave.do",
				data : $("#sub_form").serialize(),
				async : false,
				dataType:'json',
				success : function(data) {
					if(data.msg == "success"){
						f_alert("<%=path%>","success","extensioncx_getList.do");
					}else{
