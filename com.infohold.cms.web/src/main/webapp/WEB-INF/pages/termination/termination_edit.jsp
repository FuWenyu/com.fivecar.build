...
<html lang="en">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="form_sub" name="form_sub" class="col-xs-12" action=#	method="post">
							<input type="hidden" id="duebill_id" name="duebill_id"value="${bizTerminationEntry.duebill_id }"> 
							<h3 class="breadcrumb">
							...
							<input type="hidden" id="xh" name="xh" value="${bizTerminationEntry.xh }"> 
							<div class="row">
								<div class="space-6"></div>
								<div class="form-group">
									<div class="col-md-1"></div>
							...
							<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">						
										<textarea rows="5" cols="10" class="col-xs-10 col-sm-6" id="zzyy" name="zzyy" >${bizTerminationEntry.zzyy }</textarea>
									</div>
									<div class="col-md-0"></div>								     									
									<div class="col-md-1"></div>
								</div>
	...
	function AddOrUpdate(){
		    ...
		    $.ajax({
				type : "POST",
				url : "<%=path%>/mvc/termination_editSave.do",
