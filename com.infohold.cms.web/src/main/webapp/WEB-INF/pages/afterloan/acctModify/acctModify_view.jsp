...
<body id="iframe_body"
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" id="sub_form"
					...
					<input type="hidden" id="modify_id" name="modify_id" value="${map.modify_id }">
					...
					<div class="form-group">
						...
						<label class="col-sm-2 control-label no-padding-right" for="amount">
							合同金额 </label>
						<div class="col-sm-5">
							<input name="amount" id="amount" class="col-xs-10 col-sm-5" type="text"  value="${map.amount }" readonly>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input name="rep_acct" id="rep_acct" class="col-xs-10 col-sm-8" type="text" value="${map.account_old }" 
								readonly>
						</div>
						<label class="col-sm-2 control-label no-padding-right" for="account_new">
							新还款账号 </label>
						<div class="col-sm-5">
							<input name="account_new" id="account_new" placeholder="请输入新还款账号" type="text" value="${map.account_new }" 
	...
	function subForm() {
		...
		$.ajax({
			type : "POST",
			url : "<%=path%>/mvc/acctModify_editSave.do",
