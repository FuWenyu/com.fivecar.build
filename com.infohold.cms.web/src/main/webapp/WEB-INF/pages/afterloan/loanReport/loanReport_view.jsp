				...
				<div class="widget-body">
					<div class="widget-main">
							...
							<div class="step-content row-fluid position-relative"
								...
								<div class="step-pane active" id="step1">
									<input type="hidden" id="report_id" name="report_id"
										...
										id="duebill_id" name="duebill_id" value="${map.duebill_id }" />
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="duebill_ser_no" placeholder=""
												class="col-xs-10 col-sm-4" name="duebill_ser_no"
												value="${map.duebill_ser_no }" readonly />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<input type="text" id="duebill_amount" placeholder=""
												class="col-xs-10 col-sm-8" name="duebill_amount" value="${map.duebill_amount }" readonly />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="basicsituation"
												name="basicsituation" readonly>${map.basicsituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="changesituation">管理层的变动情况</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="changesituation"
												name="changesituation" readonly>${map.changesituation }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="corporatestructure"
												name="corporatestructure" readonly>${map.corporatestructure }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="financialability">财务管理能力分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="financialability"
												name="financialability" readonly>${map.financialability }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="indoorsystem"
												name="indoorsystem" readonly>${map.indoorsystem }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="customersituation">集团客户情况</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="customersituation"
												name="customersituation" readonly>${map.customersituation }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="managetactic"
												name="managetactic" readonly>${map.managetactic }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="purchase">采购环节风险分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="purchase" name="purchase" readonly>${map.purchase }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="produce" name="produce" readonly>${map.produce }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="sell">销售环节风险分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="sell" name="sell" readonly>${map.sell }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="capitalsituation"
												name="capitalsituation" readonly>${map.capitalsituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="financereliability">财务报表可信度判断</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="financereliability"
												name="financereliability" readonly>${map.financereliability }</textarea>
										</div>
									</div>
								</div>
								<div class="step-pane" id="step3">
									<div class="form-group">
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="property" name="property" readonly>${map.property }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="liabilities">对负债项目分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="liabilities"
												name="liabilities" readonly>${map.liabilities }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="customerincome"
												name="customerincome" readonly>${map.customerincome }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="customerliabilities">异常变动的资产负债及损益类项目分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="customerliabilities"
												name="customerliabilities" readonly>${map.customerliabilities }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="cashflow" name="cashflow" readonly>${map.cashflow }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="customercycle">授信客户所在行业周期</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="customercycle"
												name="customercycle" readonly>${map.customercycle }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="specialsituation"
												name="specialsituation" readonly>${map.specialsituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="relatedtrade">授信客户所在行业与相关行业的关联度分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="relatedtrade"
												name="relatedtrade" readonly>${map.relatedtrade }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="comoete" name="comoete" readonly>${map.comoete }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="isornosubstitute">授信客户产品被其他产品替代的可能性分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="isornosubstitute"
												name="isornosubstitute" readonly>${map.isornosubstitute }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="lawsituation"
												name="lawsituation" readonly>${map.lawsituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="bailsituation">保证主体资格分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="bailsituation"
												name="bailsituation" readonly>${map.bailsituation }</textarea>
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="guarantysituation"
												name="guarantysituation" readonly>${map.guarantysituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="bailfinancer">保证人财务分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="bailfinancer"
												name="bailfinancer" readonly>${map.bailfinancer }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="bailcredit"
												name="bailcredit" readonly>${map.bailcredit }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="contractsituation">借款合同履行情况</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="contractsituation"
												name="contractsituation" readonly>${map.contractsituation }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="limitingclause"
												name="limitingclause" readonly>${map.limitingclause }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="riskchange">贷款风险迁徒变动情况</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="riskchange"
												name="riskchange" readonly>${map.riskchange }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="riskwarning"
												name="riskwarning" readonly>${map.riskwarning }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="relatedwork">相关业务及客户资源需要进一步拓展和挖掘方面</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="relatedwork"
												name="relatedwork" readonly>${map.relatedwork }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="propose" name="propose" readonly>${map.propose }</textarea>
										</div>
										<!-- <label class="col-sm-2 control-label no-padding-right"
											for="isornosubstitute">授信客户产品被其他产品替代的可能性分析</label>
										<div class="col-sm-3">
								...
								<div class="step-pane" id="step5">
									...
									<div class="form-group" id="fileListGroup">
										<label class="col-sm-2 control-label no-padding-right"
											for="btn">已上传文件</label>
										<div class="col-sm-3" id="upload1">
											<c:forEach items="${map.fileList}" var="file">
												<label class='filelist col-sm-12'><a
													href="downloadFile.do?att_id=${file.att_id }">${file.att_name }&nbsp;&nbsp;&nbsp;</a><a
													class="remove" data-attid="${file.att_id }"
													data-fileName="${file.att_name }" href="#"
													onclick="removeFile(this);"><i class="icon-remove"></i></a></label>
											</c:forEach>
										</div>
										<div class="col-sm-4"></div>
									</div>
						...
						<div class="row-fluid wizard-actions">
							...
							<button class="btn btn-success btn-next" data-last="返回">
