...
<body id="iframe_body"
							...
							<div class="step-content row-fluid position-relative"
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" id="duebill_acct" placeholder="点击选择借据"
												...
												onclick="selectCustem();" value="${map.duebill_acct }"
												readonly />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="basicsituation"
												name="basicsituation">${map.basicsituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="changesituation">管理层的变动情况</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="changesituation"
												name="changesituation">${map.changesituation }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="corporatestructure"
												name="corporatestructure">${map.corporatestructure }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="financialability">财务管理能力分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="financialability"
												name="financialability">${map.financialability }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="indoorsystem"
												name="indoorsystem">${map.indoorsystem }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="customersituation">集团客户情况</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="customersituation"
												name="customersituation">${map.customersituation }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="managetactic"
												name="managetactic">${map.managetactic }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="purchase">采购环节风险分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="purchase" name="purchase">${map.purchase }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="produce" name="produce">${map.produce }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="sell">销售环节风险分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="sell" name="sell">${map.sell }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="capitalsituation"
												name="capitalsituation">${map.capitalsituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="financereliability">财务报表可信度判断</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="financereliability"
												name="financereliability">${map.financereliability }</textarea>
										</div>
									</div>
								</div>
								<div class="step-pane" id="step3">
									<div class="form-group">
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="property" name="property">${map.property }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="liabilities">对负债项目分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="liabilities"
												name="liabilities">${map.liabilities }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="customerincome"
												name="customerincome">${map.customerincome }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="customerliabilities">异常变动的资产负债及损益类项目分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="customerliabilities"
												name="customerliabilities">${map.customerliabilities }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="cashflow" name="cashflow">${map.cashflow }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="customercycle">授信客户所在行业周期</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="customercycle"
												name="customercycle">${map.customercycle }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="specialsituation"
												name="specialsituation">${map.specialsituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="relatedtrade">授信客户所在行业与相关行业的关联度分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="relatedtrade"
												name="relatedtrade">${map.relatedtrade }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="comoete" name="comoete">${map.comoete }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="isornosubstitute">授信客户产品被其他产品替代的可能性分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="isornosubstitute"
												name="isornosubstitute">${map.isornosubstitute }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="lawsituation"
												name="lawsituation">${map.lawsituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="bailsituation">保证主体资格分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="bailsituation"
												name="bailsituation">${map.bailsituation }</textarea>
										</div>
									</div>
								</div>
								<div class="step-pane" id="step4">
									<div class="form-group">
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="guarantysituation"
												name="guarantysituation">${map.guarantysituation }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="bailfinancer">保证人财务分析</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="bailfinancer"
												name="bailfinancer">${map.bailfinancer }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="bailcredit"
												name="bailcredit">${map.bailcredit }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="contractsituation">借款合同履行情况</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="contractsituation"
												name="contractsituation">${map.contractsituation }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="limitingclause"
												name="limitingclause">${map.limitingclause }</textarea>
										</div>
										<label class="col-sm-2 control-label no-padding-right"
											for="riskchange">贷款风险迁徒变动情况</label>
										<div class="col-sm-3">
											<textarea class=" form-control" id="riskchange"
												name="riskchange">${map.riskchange }</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<textarea class=" form-control" id="propose" name="propose">${map.propose }</textarea>
										</div>
										<!-- <label class="col-sm-2 control-label no-padding-right"
											for="isornosubstitute">授信客户产品被其他产品替代的可能性分析</label>
										<div class="col-sm-3">
	...
	jQuery(function($) {
		...
		.on('finished', function(e) {
			...
			$.ajax({
				type : "POST",
				url : "<%=path%>/mvc/loanReport_editSave.do",
