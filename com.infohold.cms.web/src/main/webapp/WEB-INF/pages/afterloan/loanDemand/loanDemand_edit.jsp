...
<body id="iframe_body"	onload="setHash('${pageContext.request.contextPath}')">
						...
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<select id="demand_status" class="form-control"  name="demand_status" 
									data-select-value="${loanDemandEntity.demand_status }" data-select-list="${demand_statusList }" >
								</select>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<select id="cust_type" class="form-control"  name="cust_type" 
									data-select-value="${loanDemandEntity.cust_type }" data-select-list="${pro_typeList }" >
								</select>
							</div>
						</div>
					</div>	
			 	...
			 	<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="personliable" name="personliable" value="${loanDemandEntity.personliable }"
					...
					<div class="form-group  col-sm-6">
							...
							<div class="col-sm-6 input-group">
								<select id="demand_type" class="form-control"  name="demand_type" disabled="disabled"
									data-select-value="${loanDemandEntity.demand_type }" data-select-list="${demand_typeList }" >
								</select>
							</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input id="create_date" name="create_date" value="${loanDemandEntity.create_date }"
						...
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<select id="way" class="form-control"  name="way" 
									data-select-value="${loanDemandEntity.way}" data-select-list="${demand_wayList }" >
								</select>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="address" name="address" value="${loanDemandEntity.address}"
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="contact_name"  name="contact_name" value="${loanDemandEntity.contact_name}"
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="contact_job" name="contact_job" value="${loanDemandEntity.contact_job}"
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="borrower_tel" name="borrower_tel" value="${loanDemandEntity.borrower_tel}"
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input id="refund_date" name="refund_date" value="${loanDemandEntity.refund_date}"
									class="form-control date-picker" type="text" data-date-format="yyyy-mm-dd" >
								<span class="input-group-addon"> 
									<i class="icon-calendar bigger-110"></i>
								</span>
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="effect" name="effect" value="${loanDemandEntity.effect}"
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input id="date_next" name="date_next" value="${loanDemandEntity.date_next}"
									class="form-control date-picker" type="text" data-date-format="yyyy-mm-dd" >
								<span class="input-group-addon"> 
									<i class="icon-calendar bigger-110"></i>
								</span>
						...
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<select id="way_next" class="form-control"  name="way_next" 
										data-select-value="${loanDemandEntity.way_next}" data-select-list="${demand_wayList }" >
									</select>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input id="acceptance_date" name="acceptance_date" value="${loanDemandEntity.acceptance_date}"
									class="form-control date-picker" type="text" data-date-format="yyyy-mm-dd" >
								<span class="input-group-addon"> 
									<i class="icon-calendar bigger-110"></i>
								</span>
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="collateral_change" name="collateral_change" value="${loanDemandEntity.collateral_change}"
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input id="guard_date" name="guard_date" value="${loanDemandEntity.guard_date}"
									class="form-control date-picker" type="text" data-date-format="yyyy-mm-dd" >
								<span class="input-group-addon"> 
									<i class="icon-calendar bigger-110"></i>
								</span>
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="guard_numer" name="guard_numer" value="${loanDemandEntity.guard_numer}"
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input id="noticeback_date" name="noticeback_date" value="${loanDemandEntity.noticeback_date}"
									class="form-control date-picker" type="text" data-date-format="yyyy-mm-dd" >
								<span class="input-group-addon"> 
									<i class="icon-calendar bigger-110"></i>
								</span>
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="dqzsq" name="dqzsq" value="${loanDemandEntity.dqzsq}"
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="borrower" name="borrower" value="${loanDemandEntity.borrower}"
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="guarantor" name="guarantor" value="${loanDemandEntity.guarantor}"
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="borrower_desire" name="borrower_desire" value="${loanDemandEntity.borrower_desire}"
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="borrower_ability" name="borrower_ability" value="${loanDemandEntity.borrower_ability}"
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="guarantor_desire" name="guarantor_desire" value="${loanDemandEntity.guarantor_desire}"
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="guarantor_ability" name="guarantor_ability" value="${loanDemandEntity.guarantor_ability}"
					...
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-6">
							<textarea class="form-control" name="opinion" id="opinion"
								 rows="3">${loanDemandEntity.opinion}</textarea>	
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-6">
							<textarea class="form-control" name="trend" id="trend"
								 rows="3">${loanDemandEntity.trend}</textarea>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-6">
							<textarea class="form-control" name="handle" id="handle"
								 rows="3">${loanDemandEntity.handle}</textarea>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-6">
							<textarea class="form-control" name="measures" id="measures"
								 rows="3">${loanDemandEntity.measures}</textarea>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-6">
							<textarea class="form-control" name="ps" id="ps"
								 rows="3">${loanDemandEntity.ps}</textarea>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="hidden" id="branch_no"  name="branch_no" value="${loanDemandEntity.branch_no }"/>
								<input type="text" id="branch_noname"  name="branch_noname" value="${loanDemandEntity.branch_noname }"
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="hidden" id="cust_manager"  name="cust_manager" value="${loanDemandEntity.cust_manager }"/>
								<input type="text" id="cust_managername"  name="cust_managername" value="${loanDemandEntity.cust_managername }"
	...
	function subForm(){
		...
		$.ajax({
			type : "POST",
			url : "<%=path%>/mvc/loanDemand_editSave.do",
