...
%>
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" id="sub_form"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input name="rat_int_val" id="rat_int_val" class="col-xs-10 col-sm-8" type="text"
								readonly>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select name="rat_exe_cha_new" id="rat_exe_cha_new" class="col-xs-10 col-sm-4" data-emptyoption="false" data-select-list="${CHA}" >
							</select>
							<input name="rat_exe_coe_new" id="rat_exe_coe_new"  type="text"
								class="col-xs-10 col-sm-4" onblur="get_rat_exe_coe()">
						</div>
						<label class="col-sm-2 control-label no-padding-right" for="cust_name">
							执行利率(%) </label>
						<div class="col-sm-5">
							<input name="rat_exe_val_new" id="rat_exe_val_new" class="col-xs-10 col-sm-5" type="text" readonly>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right"
						...
						<div class="col-sm-3">
							<select name="rat_ove_cha_new" id="rat_ove_cha_new" class="col-xs-10 col-sm-4" data-emptyoption="false" data-select-list="${CHA}" >
							</select>
							<input name="rat_ove_coe_new" id="rat_ove_coe_new"  type="text"
								class="col-xs-10 col-sm-4" onblur="get_rat_ove_coe()">
						</div>
						<label class="col-sm-2 control-label no-padding-right" for="cust_name">
							逾期利率(%) </label>
						<div class="col-sm-5">
							<input name="rat_ove_val_new" id="rat_ove_val_new" class="col-xs-10 col-sm-5" type="text" readonly>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right"
						...
						<div class="col-sm-3">
							<select name="rat_emb_cha_new" id="rat_emb_cha_new" class="col-xs-10 col-sm-4" data-emptyoption="false" data-select-list="${CHA}" >
							</select>
							<input name="rat_emb_coe_new" id="rat_emb_coe_new"  type="text"
								class="col-xs-10 col-sm-4" onblur="get_rat_emb_coe()">
						</div>
						<label class="col-sm-2 control-label no-padding-right" for="cust_name">
							挪用利率(%) </label>
						<div class="col-sm-5">
							<input name="rat_emb_val_new" id="rat_emb_val_new" class="col-xs-10 col-sm-5" type="text" readonly>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="ps">申请原因</label>
						<div class="col-sm-3">
					...
					<input id="rat_exe_val_old" name="rat_exe_val_old" type="hidden">
					<input id="rat_exe_cha_old" name="rat_exe_cha_old" type="hidden">
					<input id="rat_exe_coe_old" name="rat_exe_coe_old" type="hidden">
					<input id="rat_ove_val_old" name="rat_ove_val_old" type="hidden">
					<input id="rat_ove_cha_old" name="rat_ove_cha_old" type="hidden">
					<input id="rat_ove_coe_old" name="rat_ove_coe_old" type="hidden">
					<input id="rat_emb_val_old" name="rat_emb_val_old" type="hidden">
					<input id="rat_emb_cha_old" name="rat_emb_cha_old" type="hidden">
					<input id="rat_emb_coe_old" name="rat_emb_coe_old" type="hidden">
				</form>
				<!-- PAGE CONTENT ENDS -->
			</div>
			<!-- /.col -->
	...
	function subForm() {
		...
		$.ajax({
			type : "POST",
			url : "<%=path%>/mvc/rateAdjust_contract_addSave.do",
	...
	function selectContract(){
		...
		$.ajax( {
			type : "POST",
			url : "${pageContext.request.contextPath}/mvc/rateAdjust_contract_queryContract.do",
			async : false,
			success : function(obj) {
				$(obj).each(function(index){
					var $tr = "<tr><td>"+$(obj)[index].contract_id+"</td> "
								+" <td>"+$(obj)[index].con_acct+"</td> "
								+" <td>"+$(obj)[index].amount+"</td> "
								+" <td>"+$(obj)[index].cust_name+"</td> "
