				...
				<form class="form-horizontal" id="sub_form"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input name="contract_id" id="contract_id" placeholder="点击选择合同编号" type="text"
								class="col-xs-10 col-sm-8" value="${map.biz_id }" readonly>
						</div>
					...
					<div class="form-group">
						...
						<label class="col-sm-2 control-label no-padding-right" for="amount">
							合同金额 </label>
						<div class="col-sm-5">
							<input name="amount" id="amount" class="col-xs-10 col-sm-5" type="text"  value="${map.biz_amount }" readonly>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select name="rat_exe_cha_new" id="rat_exe_cha_new" class="col-xs-10 col-sm-4" data-emptyoption="false" data-select-list="${CHA}" data-select-value="${map.rat_exe_cha_new }" disabled>
							</select>
							<input name="rat_exe_coe_new" id="rat_exe_coe_new"  type="text"
								class="col-xs-10 col-sm-4"  value="${map.rat_exe_coe_new }" readonly>
						</div>
						<label class="col-sm-2 control-label no-padding-right" for="cust_name">
							执行利率(%) </label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select name="rat_ove_cha_new" id="rat_ove_cha_new" class="col-xs-10 col-sm-4" data-emptyoption="false" data-select-list="${CHA}" data-select-value="${map.rat_ove_cha_new }" disabled>
							</select>
							<input name="rat_ove_coe_new" id="rat_ove_coe_new"  type="text" value="${map.rat_ove_coe_new }" 
								class="col-xs-10 col-sm-4" readonly>
						</div>
						<label class="col-sm-2 control-label no-padding-right" for="cust_name">
							逾期利率(%) </label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select name="rat_emb_cha_new" id="rat_emb_cha_new" class="col-xs-10 col-sm-4" data-emptyoption="false" data-select-list="${CHA}" data-select-value="${map.rat_emb_cha_new }" disabled>
							</select>
