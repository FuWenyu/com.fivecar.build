			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input name="custchname" id="custchname" placeholder="点击选择客户" type="text"
								class="col-xs-10 col-sm-8" onclick="selectCustomer(1);" readonly>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input name="old_cust_manager" id="old_cust_manager" class="col-xs-10 col-sm-8" value="${sessionScope.userSession.userName}" type="text"
								readonly>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select name="new_cust_manager" id=new_cust_manager class="col-xs-10 col-sm-8" data-emptyoption="false" data-select-list="${custManagerList}" ></select>
						</div>
						<label class="col-sm-2 control-label no-padding-right" for="cust_name">
							新机构 </label>
						<div class="col-sm-5">
							<input name="branch_no_new" id="branch_no_new" class="col-xs-10 col-sm-5" type="text" value="${sessionScope.userSession.branchName}" readonly>
						</div>
					</div>
				       <div class="form-group">
						<label class="col-sm-2 control-label no-padding-right"
						...
						<div class="col-sm-3">
							<input name="branchName" id="branchName" 
								   class="col-xs-10 col-sm-5" type="text" value="${sessionScope.userSession.userName}" readonly>
						</div>
						<label class="col-sm-2 control-label no-padding-right" for="userName">
							申请时间 </label>
						<div class="col-sm-5">
							<input name="move_date" id="move_date" class="col-xs-10 col-sm-5" type="text" value="${move_date}" readonly>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="move_reason">申请原因</label>
						<div class="col-sm-3">
							<textarea class="form-control" id="move_reason" name="move_reason"></textarea>
						</div>
					</div>
					<div class="form-group">
...
<div class="modal fade bs-example-modal-lg" id="Cust_Modal" tabindex="-1"
	...
	function subForm() {
		...
		$.ajax({
			type : "POST",
			url : "<%=path%>/mvc/customerMove_addSave.do",
