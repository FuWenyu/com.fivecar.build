			...
			<div class="col-xs-12">
				...
				<input type="hidden" id="pageNo" name="pageNo"	value="${page.pageNo }" />
					<ul class="nav nav-tabs" id="myTab">
						<li class="active"><a data-toggle="tab" href="#" data-name="percustomer"> 个人客户信息
						</a></li>
...
jQuery(function($) {
	...
	ajaxLoadPage("#tabContent","<%=path%>/mvc/perCustomer_get.do?id="+id+"&viewtype="+viewtype+"&viewOrEdit=view&pageNo="+$("#pageNo").val(),param);
