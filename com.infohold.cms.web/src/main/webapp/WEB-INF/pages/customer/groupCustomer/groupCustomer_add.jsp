...
<body id="iframe_body"	onload="setHash('${pageContext.request.contextPath}')">
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<select id="is_mycust" class="form-control"  name="is_mycust" 
									data-select-value="2" data-select-list="${yesornoList }" onchange="Check_Mycust();">
								</select>
							</div>
						</div>
					</div>
			 	...
			 	<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="groupname" name="groupname" onclick="get_Mycust();"
									class="form-control" placeholder="集团名称" >
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="organizationcode" name="organizationcode" onclick="get_Mycust();"
 ...
 <jsp:include page="getGroupcust_modal.jsp"></jsp:include><!-- 引客户 -->
	...
	function subForm(){
		...
		$.ajax({
			type : "POST",
			url : "<%=path%>/mvc/groupCustomer_add.do",
