...
<html lang="en">
				...
				<form class="form-horizontal" id="sub_form" action="" method="post">
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							<label class="col-sm-4 control-label" for="custchname">客户名称</label>
							<div class="col-sm-6 input-group">
								<input type="text" id="custchname" name="custchname"   onclick="selectCustomer(1);"
									class="form-control" placeholder="选择客户"  readonly="readonly">
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<input type="hidden" id="sqlb" name="sqlb">
							<input type="hidden" id="khlx" name="khlx">
							<input type="text" id="lbmc" name="lbmc"  class="form-control"  readonly="readonly">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								...
								<input type="hidden" id="sqjg" value="${sqjgbh}" name="sqjg">
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								...
								class="form-control" placeholder="" disabled="disabled">
								<input type="hidden" id="sqr" value="${sqrbh}" name="sqr">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group col-sm-6">
					  	<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<textarea rows="5" cols="40" id="sqyy" name="sqyy"></textarea>
							</div>
						</div>
					</div>
				</div>
	...
	<jsp:include page="../customerBlackList/customerBlack_modal.jsp"></jsp:include><!-- 引客户 -->
	...
	//表单提交
		function subForm() {
			...
			$.ajax({
				type : "POST",
				url : "<%=path%>/mvc/customerBlackList_addSave.do",
				data : $("#sub_form").serialize(),
				async : false,
				dataType:'json',
				success : function(data) {
					if(data.msg == "success"){
						f_alert("<%=path%>","success","customerBlackList_getList.do");
					}else{
