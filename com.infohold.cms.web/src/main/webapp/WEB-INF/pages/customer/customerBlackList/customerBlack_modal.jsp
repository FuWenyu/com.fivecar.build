...
function selectCustomer(pageNo){
	...
	$.ajax( {
		type : "POST",
		url : "${pageContext.request.contextPath}/mvc/customerBlack_getCustomerList.do?pageNo="+pageNo,
		async : false,
		success : function(obj) {
			...
			$(obj[1]).each(function(index){
				 var $tr = "<tr class=\"sub_data_tr_1\"><td>"+$(obj[1])[index].cust_id+"</td> "
							+" <td>"+$(obj[1])[index].cust_name+"</td> "
							+" <td>"+$(obj[1])[index].c_typename+"</td> "
							+" <td>"+$(obj[1])[index].c_number+"</td> "
							+" <td>"+$(obj[1])[index].khlxname+"</td> "
							+" <td><button type=\"button\" onclick=\"CallBackSubmit0('"
									+$(obj[1])[index].cust_id+","
									+$(obj[1])[index].cust_name+","
									+$(obj[1])[index].khlx+","
									+$(obj[1])[index].sqlb+","
									+$(obj[1])[index].lbmc+"');\">选择</button></td> "
							+" </tr>";
...
function CallBackSubmit0(custList){
