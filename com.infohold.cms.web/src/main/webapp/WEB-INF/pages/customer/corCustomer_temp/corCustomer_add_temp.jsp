...
<body id="iframe_body"
						...
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="cust_id" name="cust_id"
									class="form-control" placeholder="客户编号" >
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="custchname" name="custchname"
									class="form-control" placeholder="客户中文全称">
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="custjcname" name="custjcname"
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="custenname" name="custenname"
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<input type="text" id="organizationcode" name="organizationcode"
									class="form-control" placeholder="组织机构代码" >
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<select id="cust_property" class="form-control"  name="cust_property" data-emptyoption="true"
								 data-select-list="${cust_propertyList }"></select>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<select id="file_type" class="form-control"  name="file_type"
								 data-select-list="${fileTypeList }"></select>
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="file_number" name="file_number"
									class="form-control" placeholder="文件编号">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">	
								...
								data-select-list="${countryList }"></select>
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								...
								data-select-list="${cantonList }"></select>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="corproate_startdate" name="corproate_startdate"
				...
				<div class="row">
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="rentcode"  name="rentcode" 
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="input-group col-sm-6">
								...
								data-select-list="${currencyList }"></select>
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="registercapital_amount"  name="registercapital_amount" 
				...
				<div class="row">
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="paidincapital_amount"  name="paidincapital_amount" 
				...
				<div class="row">
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="general_assets"  name="general_assets" 
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="input-group col-sm-6">
								<input type="text" id="manage_address"  name="manage_address" 
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="practitioner_number"  name="practitioner_number" 
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="input-group col-sm-6">
								<input type="text" id="basicaccount_bank"  name="basicaccount_bank" 
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="basicaccount_number"  name="basicaccount_number" 
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="loancard_no"  name="loancard_no" 
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="legal_per_no"  name="legal_per_no" 
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="legal_per_name"  name="legal_per_name" 
				...
				<div class="row">
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="legal_per_cardno"  name="legal_per_cardno" 
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="contributor_no"  name="contributor_no" 
				...
				<div class="row">
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="contributor_cardno"  name="contributor_cardno" 
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="finance_tel"  name="finance_tel" 
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="borrower_regaddress"  name="borrower_regaddress" 
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="borrower_mesaddress"  name="borrower_mesaddress" 
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="borrower_URL"  name="borrower_URL" 
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="borrower_zipcode"  name="borrower_zipcode" 
						...
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">	
								<select id="corporate_grade_flag" class="form-control"  name="corporate_grade_flag" data-emptyoption="true"
								 data-select-list="${gradeList }"></select>
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<select id="profession_type_flag" class="form-control"  name="profession_type_flag" data-emptyoption="true"
								 data-select-list="${profession_type_flagList }"></select>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="step-pane" id="step4">
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_jtkh_check" id="is_jtkh_check" type="hidden">
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_jxs_check" id="is_jxs_check" type="hidden" >
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_whgd_check" id="is_whgd_check" type="hidden" >
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_ssgs_check" id="is_ssgs_check" type="hidden" >
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_zfrzptkh_check" id="is_zfrzptkh_check" type="hidden">
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_jgkh_check" id="is_jgkh_check" type="hidden">
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_whedsxkh_check" id="is_whedsxkh_check" type="hidden">
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_yjckq_check" id="is_yjckq_check" type="hidden">
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-4 input-group">
							<div class="radio">
								<input name="is_blblzckh_check" id="is_blblzckh_check" type="hidden" >
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_nkmdkh_check" id="is_nkmdkh_check" type="hidden" >
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_zzgkh_check" id="is_zzgkh_check" type="hidden" >
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_jrtykh_check" id="is_jrtykh_check" type="hidden"  >
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_zbldfxkh_check" id="is_zbldfxkh_check" type="hidden" >
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_zblgylrz_check" id="is_zblgylrz_check" type="hidden" >
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-6 input-group">
							<div class="radio">
								<input name="is_xmrz_check" id="is_xmrz_check" type="hidden"  >
				...
				<div class="row">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-10 input-group">
							<div class="radio">
								<input name="is_zblmyrz_check" id="is_zblmyrz_check" type="hidden" >
		...
		<div class="wizard-actions center">
			<div class="row">
				...
				<div class="col-sm-9">
					...
					<button class="btn btn-sm btn-primary" type="button" onclick="history.go(-1)">
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			$('#fuelux-wizard').ace_wizard(
				 ...
				 if (!checkData('cust_id', '客户编号', 'number')) {
					 return false;
				}
				 if (!checkData('custchname', '客户名称', 'input')) {
					 return false;
				}
				 if (!checkData('custchname', '客户名称', 'length_custName')) {
						return false;
				} 
				...
				if (!checkData('register_no', '登记注册编号', 'input')) {
					return false;
				}
				...
				if (!checkData('loancard_no', '贷款卡号', 'input')) {
					return false;
				}
	...
	function subForm(){
		$.ajax({
			type : "POST",
			url : "<%=path%>/mvc/corCustomer_addSave_temp.do",
			data : $("#sub_form").serialize(),
			async : false,
			dataType:'json',
			success : function(data) {
				if(data.msg == "success"){
					f_alert("<%=path%>","success","corCustomer_getList_temp.do");
				}else{
