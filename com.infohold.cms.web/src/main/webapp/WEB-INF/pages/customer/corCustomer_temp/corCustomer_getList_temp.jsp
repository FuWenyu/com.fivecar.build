...
<body id="iframe_body" onload="setHash('${pageContext.request.contextPath}')">
	...
	<div class="row">
	<div class="col-xs-12">
		<form class="col-xs-12" id="queryForm" name="queryForm" action="<%=path%>/mvc/corCustomer_getList_temp.do" method="post">
			<div class="row">
	...
	<script type="text/javascript">
		function viewEntity(id){
			window.location="<%=path%>/mvc/corCustomer_get_temp.do?id="+id+"&viewOrEdit=view&pageNo="+$("#pageNo").val();
		}
		function editEntity(id){
			window.location="<%=path%>/mvc/corCustomer_get_temp.do?id="+id+"&viewOrEdit=edit&pageNo="+$("#pageNo").val();
		}
		function querySubmit(){
			var param = $("#queryForm").serialize();
			param += "&qry_type=qry";
			$.post("corCustomer_getList_temp.do", param, function(result) {			
		...
		function deleteEntity(id){
			...
			$.ajax({
				type : "POST",
				url : "<%=path%>/mvc/corCustomer_delete_temp.do",
				data : param,
				async : false,
				dataType:'json',
