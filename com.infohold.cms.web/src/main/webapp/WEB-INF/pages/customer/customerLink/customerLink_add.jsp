...
<html lang="en">
						...
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="cust_id" name="cust_id"  value="${contractEntrty.custid}"  onclick="selectCustomer(1);"
									class="form-control" placeholder="请输入引入客户编号"  readonly="readonly">
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
							<input type="text" id="khlx1" name="khlx1"
								class="form-control" placeholder="" readonly="readonly">
								<input id="custtype"  name="custtype" type="hidden">
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="yrrbh" value="${yrrbh}" name="yrrbh"
								class="form-control" placeholder="" readonly="readonly">
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="form-group col-sm-6">
					  	<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<textarea rows="5" cols="40" id="yryy" name="yryy"></textarea>
							</div>
						</div>
					</div>
				</div>
	...
	<jsp:include page="../customerLink/customerLink_modal.jsp"></jsp:include><!-- 引客户 -->
	...
	//表单提交
		function subForm() {
			...
			$.ajax({
				type : "POST",
				url : "<%=path%>/mvc/customerLink_addSave.do",
				data : $("#sub_form").serialize(),
				async : false,
				dataType:'json',
				success : function(data) {
					if(data.msg == "success"){
						f_alert("<%=path%>","success","customerLink_getList.do");
					}else{
