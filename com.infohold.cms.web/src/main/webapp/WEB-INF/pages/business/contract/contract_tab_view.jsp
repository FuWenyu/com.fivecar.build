...
<html lang="en">
	...
	<script type="text/javascript">
		...
		ajaxLoadPage("#tabContent","<%=path%>/mvc/contract_view.do?contract_id="+contract_id,param);
		$("#tabbale a").on("click",function(){
			...
			if(tabName == 'contract'){
				...
				ajaxLoadPage("#tabContent","<%=path%>/mvc/guarantee_getList.do?contract_id="+contract_id+"&viewFlag=2",param);
