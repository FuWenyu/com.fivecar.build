...
<html lang="en">
	...
	<script type="text/javascript">
			jQuery(function($) {
				...
				$.post("<%=path%>/mvc/contract_edit.do?contract_id="+contract_id, function(result) {
					$("#contract").html(result);
				});
				
				$("#myTab a").on('click',function(){
					if($(this).attr("data-name")=="contract"){
					
							$("#contract").addClass("in").addClass("active");
							$("#guarantee").removeClass("in").removeClass("active");
						
							$.post("<%=path%>/mvc/contract_edit.do?contract_id="+contract_id, function(result) {
								$("#contract").html(result);
							});
						
					}else if($(this).attr("data-name")=="guarantee"){
						$("#guarantee").addClass("in").addClass("active");
						$("#contract").removeClass("in").removeClass("active");
