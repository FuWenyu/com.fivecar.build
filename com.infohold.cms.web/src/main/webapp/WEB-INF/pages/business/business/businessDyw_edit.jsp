		...
		<div class="row">
			<div class="col-xs-12">
				...
				<input type="hidden" id="pageNo" name="pageNo"	value="${page.pageNo }" />
					...
					<div class="form-group col-sm-6">
						<div class="form-group">
							<label class="col-sm-4 control-label" for="zl">抵押物种类</label>
							<div class="col-sm-6 input-group">
								<select id="zl" class="form-control"  name="zl"
								 data-select-list="${dywList }"  data-select-value="${bizFsxx.dywzl }"  disabled="disabled"></select>
							</div>
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="pgje" value="${bizFsxx.dywpgje}" name="pgje"
								class="form-control" >
								<input type="hidden" id="dywyprq" value="${bizFsxx.dywyprq}" name="dywyprq"
								class="form-control date-picker" data-date-format="yyyy-mm-dd">
								<input type="hidden" id="dywsl" value="${bizFsxx.dywsl}" name="dywsl"
								class="form-control" >
							</div>
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6 input-group">
								<input type="text" id="dbje" value="${bizFsxx.dywdbje}" name="dbje"
