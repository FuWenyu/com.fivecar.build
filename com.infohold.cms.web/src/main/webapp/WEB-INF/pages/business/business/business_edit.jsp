...
<html lang="en">
	...
	-->
	<body id="iframe_body" onload="setHash('${pageContext.request.contextPath}');getLimit(${bizBusinessEntity.xhbzvalue});">
							...
							<div class="step-pane active" id="step1">
								<div class="row">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" id="cust_id" name="cust_id"  value="${bizBusinessEntity.custid}"  
										...
										<div class="col-sm-4">
										<input type="text" id="custchname" name="custchname"  value="${bizBusinessEntity.custname}"  
								...
								<div class="space-6"></div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" id="prodname"  readonly="readonly"
											class="col-xs-10 col-sm-5" name="prodname" value="${bizBusinessEntity.prodname}" />
											<input type="hidden" id="prodcode" name="prodcode" value="${bizBusinessEntity.prodcode}">
											<input type="hidden" id="xhbz" name="xhbz" value="${bizBusinessEntity.xhbzvalue}">
										...
										<div class="col-sm-4">
											<input type="text" id="prodcode"  readonly="readonly"
											class="col-xs-10 col-sm-5" name="prodcode"  value="${bizBusinessEntity.prodcode}" />
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select id="ccycode" class="col-xs-10 col-sm-5"  name="ccycode"
								 			data-select-list="${ccycodeList }" data-select-value="${bizBusinessEntity.ccycode}"></select>
										</div>
										<div class="col-md-0"></div>
										<label class="col-sm-1 control-label no-padding-right"
										...
										<input type="text" id="amount"  
												class="col-xs-10 col-sm-5" name="amount" value="${bizBusinessEntity.amount}" onblur="qklimitid()"/>
										</div>
										<div class="col-md-1"></div>
									</div>
							    </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select id="dkyt" class="col-xs-10 col-sm-5"  name="dkyt"
								 			data-select-list="${dkytList }" data-select-value="${bizBusinessEntity.dkyt}"></select>
										</div>
										 -->
										 <label class="col-sm-1 control-label no-padding-right"
										...
										<div class="col-sm-4">
											<select id="hkfs" class="col-xs-10 col-sm-5"  name="hkfs"
								 			data-select-list="${hkfsList }" data-select-value="${bizBusinessEntity.hkfs}"></select>
										</div>
										<div class="col-md-0"></div>
										<label class="col-sm-1 control-label no-padding-right"
										...
										<input type="text" id="dkqx"  
											placeholder="请输入整月数"	class="col-xs-10 col-sm-5" name="dkqx" value="${bizBusinessEntity.dkqx}" onblur="checkNumber()"/>
										</div>
										<div class="col-md-1"></div>
									</div>
							    </div>
							    ...
							    <div class="row">
									<div class="form-group">
										...
										<select id="zydbfs" class="col-xs-10 col-sm-5"  name="zydbfs"
								 			data-select-list="${dbList }" data-select-value="${bizBusinessEntity.zydbfsvalue}"></select>
										</div>
										<div class="col-md-1"></div>
									</div>
							    </div>
							    ...
							    <div class="row" id="limit" style="display: none">
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											placeholder="请输入选择关联额度编号"	class="col-xs-10 col-sm-5" name="limitid"  onclick="selectLimit(1);" value="${bizBusinessEntity.limitid }"/>
											<input type="hidden" id="creditBalance"   name="creditBalance" />
							...
							<div class="step-pane" id="step2">
									...
									<div class="space-6"></div>
										<div class="form-group">
											<div class="col-md-2"></div>
												...
												<div class="col-sm-4">
												<select name="jzllhqfs" id="jzllhqfs"  class="col-xs-10 col-sm-5" data-emptyoption="true" data-select-list="${jzllhqfsList}" data-select-value="${bizBusinessEntity.jzllhqfs}"></select>
												</div>
											<div class="col-md-0"></div>
											...
											<div class="col-sm-4">
												<input type="text" 
													class="col-xs-10 col-sm-5" name="jzllz" id="jzllz" value="${bizBusinessEntity.jzllz }" placeholder="请输入利率值（%）"/>
											</div>
											<div class="col-md-1"></div>
										</div>
								</div>
								...
								<div class="space-6"></div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="zxlljsfs" id="zxlljsfs"  class="col-xs-10 col-sm-5" data-emptyoption="false" data-select-list="${zxlljsfsList}" data-select-value="${bizBusinessEntity.zxlljsfs}"></select>
										</div>
										<div class="col-md-1"></div>
									</div>
								</div>
								...
								<div class="space-6"></div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="zxllbdfs" id="zxllbdfs"  class="col-xs-10 col-sm-5" data-emptyoption="false" data-select-list="${llbdlxList}" data-select-value="${bizBusinessEntity.zxllbdfs}" onchange="get_zxllbdxs()"></select>
								...
								<div class="space-6"></div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="yqllbdfs" id="yqllbdfs"  class="col-xs-10 col-sm-5" data-emptyoption="false" data-select-value="${bizBusinessEntity.yqllbdfs}" data-select-list="${llbdlxList}"  onchange="get_yqllbdxs()"></select>
								...
								<div class="space-6"></div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="nyllbdfs" id="nyllbdfs"  class="col-xs-10 col-sm-5" data-emptyoption="false" data-select-value="${bizBusinessEntity.nyllbdfs}" data-select-list="${llbdlxList}"  onchange="get_nyllbdxs()"></select>
									...
									<div class="space-6"></div>
										<div class="form-group">
											<div class="col-md-2"></div>
												...
												<div class="col-sm-4">
												<select name="lltzsj" id="lltzsj"  class="col-xs-10 col-sm-5" data-emptyoption="false" data-select-value="${bizBusinessEntity.lltzsj}" data-select-list="${lltzfsList}" ></select>
												</div>
											<div class="col-md-0"></div>
											...
											<div class="col-sm-4">
												<select name="flbz" id="flbz"  class="col-xs-10 col-sm-5" data-emptyoption="false" data-select-list="${flbzList}" data-select-value="${bizBusinessEntity.flbz}"></select>
											</div>
											<div class="col-md-1"></div>
										</div>
								</div>
				...
				.on('finished', function(e) {
					...
					****/
					...
					if (document.getElementById("xhbz").value=="2") {
						if (document.getElementById("limitid").value==""||document.getElementById("limitid").value==null) {
							f_alert("<%=path%>","循环贷款请关联额度！","");
							return false;
						}
					...
					$.ajax({
						type : "POST",
						url : "<%=path%>/mvc/business_editSave.do",
