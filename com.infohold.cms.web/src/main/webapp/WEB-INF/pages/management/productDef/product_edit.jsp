				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" id="sub_form" action="<%=path%>/mvc/productDef_editSave.do" method="post">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" id="pro_name" placeholder="请输入产品名称" class="col-xs-10 col-sm-5" name="pro_name" value="${entity.pro_name }"  maxlength="15"/>
							</div>
				       </div>
				       <div class="form-group">
							<label class="col-sm-2 control-label no-padding-right" for="pro_type"> 产品类型 </label>
							<div class="col-sm-3">
								<select name="pro_type" id="pro_type" class="col-xs-10 col-sm-8" data-emptyoption="false" data-select-list="${proTypeList }" data-select-value="${entity.pro_type }">
								</select>
							</div>
							<label class="col-sm-2 control-label no-padding-right" for="cny"> 币种 </label>
							<div class="col-sm-5">
								<select name="cny" id="cny" class="col-xs-10 col-sm-5" data-emptyoption="false" data-select-list="${cnyList}" data-select-value="${entity.cny }">
								</select>
							</div>
				       </div>
				       <div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="ps" placeholder="请输入产品描述" class="col-xs-10 col-sm-8" name="ps" value="${entity.ps }"  maxlength="32"/>
							</div>
