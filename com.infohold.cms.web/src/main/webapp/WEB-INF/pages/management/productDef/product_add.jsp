...
<html lang="en">
				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" id="sub_form" action="<%=path%>/mvc/productDef_addSave.do" method="post">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="pro_code" placeholder="请输入产品代码" class="col-xs-10 col-sm-8" name="pro_code" maxlength="15"/>
							</div>
							<label class="col-sm-2 control-label no-padding-right" for="pro_name"> 产品名称 </label>
							<div class="col-sm-5">
								<input type="text" id="pro_name" placeholder="请输入产品名称" class="col-xs-10 col-sm-5" name="pro_name"  maxlength="15"/>
							</div>
				       </div>
				       <div class="form-group">
							<label class="col-sm-2 control-label no-padding-right" for="pro_type"> 产品类型 </label>
							<div class="col-sm-3">
								<select name="pro_type" id="pro_type" class="col-xs-10 col-sm-8" data-emptyoption="false" data-select-list="${proTypeList }" data-select-value="1">
								</select>
							</div>
							<label class="col-sm-2 control-label no-padding-right" for="cny"> 币种 </label>
							<div class="col-sm-5">
								<select name="cny" id="cny" class="col-xs-10 col-sm-5" data-emptyoption="false" data-select-list="${cnyList}" data-select-value="CNY">
								</select>
							</div>
				       </div>
				       <div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="ps" placeholder="请输入产品描述" class="col-xs-10 col-sm-8" name="ps"  maxlength="32"/>
							</div>
				       ...
				       <div class="form-group">
							...
							<div class="col-sm-3">
								<select name="postpone_flag" id="postpone_flag" class="col-xs-10 col-sm-8" >
							...
							<div class="col-sm-5">
								<select name="guaranteechange_flag" id="guaranteechange_flag" class="col-xs-10 col-sm-5" >
									<option value="0">否</option>
									<option value="1" selected>是</option>
								</select>
							</div>
				       ...
				       <div class="form-group">
							...
							<div class="col-sm-3">
								<select name="loan_type" id="loan_type" class="col-xs-10 col-sm-8" >
				       ...
				       <div class="form-group">
							...
							<div class="col-sm-6">
								<div class="checkbox" id="rep_way" name="rep_way" data-check-list="${repayTypeList}" data-check-value="1">
								</div>
							</div>
				       </div>
	...
	function subForm() {
		...
		$.ajax({
			type : "POST",
			url : "<%=path%>/mvc/productDef_addSave.do",
